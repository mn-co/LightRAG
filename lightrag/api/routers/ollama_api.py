...
from lightrag.api.workspace import WorkspaceContext, WorkspaceManager
...
class OllamaAPI:
    def __init__(
        ...
        ollama_server_infos: Optional[OllamaServerInfos] = None,
    ):
        if ollama_server_infos is None:
            raise ValueError("ollama_server_infos must be provided for OllamaAPI")
